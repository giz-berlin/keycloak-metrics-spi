...
If setting an authentication is not an option, you can set the environment variable `DISABLE_EXTERNAL_ACCESS`.
Once set, requests where the header 'X-Forwarded-Host' header is set will be denied.
